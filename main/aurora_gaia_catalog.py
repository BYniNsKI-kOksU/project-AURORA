...
#OUTPUT = asset_path("aurora_gaia_catalog_1_8mld.fits")
OUTPUT = Path("/Volumes/Extreme SSD/aurora/data/assets/aurora_gaia_catalog_1_8mld.fits")
#RECORDS_DIR = ASSETS_DIR / "gaia_chunks"
RECORDS_DIR = Path("/Volumes/Extreme SSD/aurora/fity")
CHUNK_PREFIX = "gaia_chunk"
N_CHUNKS = 60
PER_CHUNK = 30_200_000
QUERY_TIMEOUT = 60 * 60
